...
//This code has been adapted from examples and documentation from https://www.gnu.org/software/ncurses/
...
char* printMenu(const char welcome[])
{
    ...
    init_pair(1, COLOR_GREEN, COLOR_BLACK); //colour selection
